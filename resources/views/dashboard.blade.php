            ...
            <table class="w-full divide-y divide-gray-200">
                ...
                @foreach (App\Models\Post::all() as $post)
                    ...
                    <td class="px-6 py-4 text-right text-sm">
                        @can('edit post')
                        <a href="{{ route('posts.edit', $post->id) }}"><button class="btn btn-success">Edit</button></a>
                        @endcan
                        @can('publish post')                        
                        <a href="#" class="m-2 p-2 bg-green-400 rounded"><button class="btn btn-success">Publish</button></a>
                        @endcan
                    </td>
                </tr> 
                @endforeach
